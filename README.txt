...
A personal job scraper that checks a curated list of 161 companies in
...
- `config/cv_profile.yaml` — update if your CV changes, or adjust
  which job titles count as "PM roles."
